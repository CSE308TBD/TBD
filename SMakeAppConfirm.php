	...
	<div class="wrap">
		<div class="full_wrap">
			...
			<div class="main_content">
				<?php $examId=$_SESSION['examId'];
				      $userId=$_SESSION['userID'];
			     include('connect.php');
                 $sql = " insert into appointment (appId, userId, examId, courseName, examName, startDate, startTime) values (NULL,'$userId','$examId','cse308','final','2015-11-13','12:00:00')";
                 if (mysql_query($sql)) {
